...
function SkinExamples() {
    ...
    return (
        <div id="examples-skin">
            ...
            <p>Visit <a href="/api/skin/Ryuk" rel="noreferrer" target="_blank">/api/skin/Ryuk</a> for raw version.</p>
            <h3>The API is adapts to all rarities of costumes and is updated as long as Identity V Fandom is still up to date.</h3>
            <p>Getting <a href={"https://id5.fandom.com/\"Abyss\""} rel="noreferrer" target="_blank">Nightmare's S</a> costume: </p>
            <CodeBlock className="language json" code={abyssData} />
            <p>Raw version at <a href={"/api/skin/\"Abyss\""} rel="noreferrer" target="_blank">/api/skin/"Abyss"</a>.</p>
        </div>
    );
}
